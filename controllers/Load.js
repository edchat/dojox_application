define(["require", "dojo/_base/lang", "dojo/_base/declare", "dojo/on", "dojo/Deferred", "dojo/when",
	"dojo/_base/array", "dojo/dom-construct", "dijit/registry", "../Controller"],
	function(require, lang, declare, on, Deferred, when, array, domConstruct, registry, Controller, View){ // why is View here?
	// module:
	...
	return declare("dojox.app.controllers.Load", Controller, {
		...
		unloadView: function(event){
			...
			this.app.log("in app/controllers/Load app-unload-view event.viewId="+event.viewId+" event =", event);
